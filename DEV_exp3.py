...
# 1. Concatenate - Combine df1 and df2 vertically (row-wise)
df_concat = pd.concat([df1, df2], ignore_index=True)
print("Concatenated DataFrame (Vertical):")
print(df_concat)

# You can also concatenate horizontally (column-wise)
...
# 2. Merge - SQL style join, merge on 'Name' to add department info
extra_info = {
...
# 3. Join - Use index-based joining (by default)
# Create a DataFrame with index as 'Name' to join with df_info
...
# You can also specify join type ('inner', 'outer', 'left', 'right')
